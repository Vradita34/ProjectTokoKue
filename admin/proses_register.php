...
if (isset($_POST['submit'])) {
    ...
    $tipe_petugas = $_POST['tipe_petugas'];

    // Validasi data
    if (empty($nama_lengkap) || empty($username) || empty($email) || empty($password) || empty($confirm_password)  || empty($tipe_petugas)) {
    ...
    $query = "INSERT INTO petugas (nama_lengkap, email, username, password,tipe_petugas) VALUES ('$nama_lengkap', '$email', '$username', '$password','$tipe_petugas')";
