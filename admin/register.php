                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="proses_register.php">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputFirstName" type="text" placeholder="Enter your first name" name="nama_lengkap" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <label for="inputTipe">Tipe Petugas</label>
                                                <select class="form-control" name="tipe_petugas">
