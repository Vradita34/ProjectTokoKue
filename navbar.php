                        ...
                        <div class="header__top__inner">
                            ...
                            <div class="header__top__right">
                                <div class="header__top__right__links">
                                    <a href="#" class="search-switch"><img src="assets/img/icon/search.png" alt=""></a>
                                    <a href="pelanggan/wisslist.php"><img src="assets/img/icon/heart.png" alt=""></a>
                                </div>
                ...
                <div class="col-lg-12">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li><a href="#">Pages</a>
                                <ul class="dropdown">
                                    <li><a href="./pelanggan/shoping-cart.php">Shoping Cart</a></li>
                                    <li><a href="./pelanggan/checkout.php">Check Out</a></li>
                                    <li><a href="./pelanggan/wisslist.php">Wisslist</a></li>
